...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<test-unit>.freeze, ["~> 2.3".freeze])
  s.add_development_dependency(%q<shoulda>.freeze, ["~> 2.11.3".freeze])
  s.add_development_dependency(%q<rack>.freeze, ["~> 1.2.0".freeze])
  s.add_development_dependency(%q<rack-test>.freeze, ["~> 0.5.4".freeze])
end
