# -*- encoding: utf-8 -*-
# stub: image_optim 0.31.3 ruby lib

Gem::Specification.new do |s|
  s.name = "image_optim".freeze
  s.version = "0.31.3".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/toy/image_optim/issues", "changelog_uri" => "https://github.com/toy/image_optim/blob/master/CHANGELOG.markdown", "documentation_uri" => "https://www.rubydoc.info/gems/image_optim/0.31.3", "source_code_uri" => "https://github.com/toy/image_optim" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<fspath>.freeze, ["~> 3.0".freeze])
  s.add_runtime_dependency(%q<image_size>.freeze, [">= 1.5".freeze, "< 4".freeze])
  s.add_runtime_dependency(%q<exifr>.freeze, ["~> 1.2".freeze, ">= 1.2.2".freeze])
  s.add_runtime_dependency(%q<progress>.freeze, ["~> 3.0".freeze, ">= 3.0.1".freeze])
  s.add_runtime_dependency(%q<in_threads>.freeze, ["~> 1.3".freeze])
  s.add_development_dependency(%q<image_optim_pack>.freeze, ["~> 0.2".freeze, ">= 0.2.2".freeze])
